...
//                            yonghuEntity.setYonghuName(data.get(0));                    //职工姓名 要改的
//                            yonghuEntity.setYonghuPhoto("");//照片
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //职工手机号 要改的
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //职工身份证号 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "职工");
        R r = R.ok();
        r.put("token", token);
        r.put("role","职工");
